    ...
    export namespace GI {
        ...
        namespace WebKit {
            ...
            interface NetworkSession extends GObject.Object {
                ...
                readonly $writableProperties: NetworkSession.WritableProperties
                readonly $constructOnlyProperties: NetworkSession.ConstructOnlyProperties
                /**
            ...
            interface NetworkSessionClass extends Omit<GObject.ObjectClass, "new"> {
                 ...
                 */
                "new"(data_directory: string | null, cache_directory: string | null): NetworkSession
                /**
            ...
            namespace WebExtension {
                ...
                interface ReadableProperties extends ReadWriteProperties, GObject.Object.ReadableProperties, Gio.Initable.ReadableProperties {
                    ...
                    "display-short-name": string | null
                    "display-version": string | null
                    "has-background-content": boolean
                    "has-commands": boolean
                    "has-content-modification-rules": boolean
                    "has-injected-content": boolean
                    "has-options-page": boolean
                    "has-override-new-tab-page": boolean
            ...
            interface WebExtensionClass extends Omit<GObject.ObjectClass, "new"> {
                 ...
                 * @throws {GLib.Error}
                 * @since 2.52
                 * @param extension_path A string pointing to the folder containing the extension manifest and resources
                 * @returns the new #WebKitWebExtension, or %NULL if the extension failed to be created
                 */
            ...
            namespace WebView {
                interface SignalSignatures extends WebViewBase.SignalSignatures, Gtk.Accessible.SignalSignatures, Gtk.Buildable.SignalSignatures, Gtk.ConstraintTarget.SignalSignatures {
                    /**
                     ...
                     * @returns %TRUE to stop other handlers from being invoked for the event.    %FALSE to propagate the event further.
                     */
                    "context-menu"(context_menu: ContextMenu, hit_test_result: HitTestResult): boolean
                    /**
                     ...
                     * @returns %TRUE to stop other handlers from being invoked for the event.   %FALSE to propagate the event further.
                     */
                    "show-option-menu"(menu: OptionMenu, rectangle: Gdk.Rectangle): boolean
                    /**
                ...
                interface ReadWriteProperties extends WebViewBase.ReadWriteProperties, Gtk.Accessible.ReadWriteProperties, Gtk.Buildable.ReadWriteProperties, Gtk.ConstraintTarget.ReadWriteProperties {
            ...
            interface WebExtensionMatchPatternStruct {
                 ...
                 * @throws {GLib.Error}
                 * @since 2.48
                 * @param scheme A pattern URL scheme
                 * @param host A pattern URL host
