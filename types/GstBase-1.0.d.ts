    ...
    export namespace GI {
        ...
        namespace GstBase {
            ...
            interface Adapter extends GObject.Object {
                ...
                readonly $writableProperties: Adapter.WritableProperties
                readonly $constructOnlyProperties: Adapter.ConstructOnlyProperties
                /**
            ...
            interface Aggregator extends Gst.Element {
                ...
                readonly $writableProperties: Aggregator.WritableProperties
                readonly $constructOnlyProperties: Aggregator.ConstructOnlyProperties
                /**
                ...
                set minUpstreamLatency(value: number)
                /**
                ...
                /**
                 * @default GST_AGGREGATOR_START_TIME_SELECTION_ZERO
                 */
                get startTimeSelection(): AggregatorStartTimeSelection
                set startTimeSelection(value: AggregatorStartTimeSelection)
                /**
            ...
            interface BaseParse extends Gst.Element {
                ...
                set disablePassthrough(value: boolean)
                /**
                 ...
                 * @returns %TRUE if conversion was successful., Pointer where the conversion result will be put.
                 */
            ...
            interface BaseSink extends Gst.Element {
                ...
                readonly $writableProperties: BaseSink.WritableProperties
                readonly $constructOnlyProperties: BaseSink.ConstructOnlyProperties
                /**
                ...
                set enableLastSample(value: boolean)
                /**
                ...
                set processingDeadline(value: number)
                /**
                 * @default FALSE
                 */
                get qos(): boolean
                 ...
                 * @param buffer
                 * @returns , the start #GstClockTime, the end #GstClockTime
                 */
            ...
            interface BaseSrc extends Gst.Element {
                ...
                readonly $writableProperties: BaseSrc.WritableProperties
                readonly $constructOnlyProperties: BaseSrc.ConstructOnlyProperties
                /**
                ...
                set automaticEos(value: boolean)
                /**
                 * @default 4096
                 */
                get blocksize(): number
                ...
                set doTimestamp(value: boolean)
                /**
                 * @default -1
                 */
                get numBuffers(): number
                set numBuffers(value: number)
                /**
                 * @default FALSE
                 */
                get typefind(): boolean
                set typefind(value: boolean)
                /**
                ...
                get_blocksize(): number
                /**
                 * @returns the instance of the #GstBufferPool used by the src; unref it after usage.
                 */
                get_buffer_pool(): Gst.BufferPool | null
                /**
            ...
            interface BaseTransform extends Gst.Element {
                ...
                readonly $writableProperties: BaseTransform.WritableProperties
                readonly $constructOnlyProperties: BaseTransform.ConstructOnlyProperties
                /**
                 * @default FALSE
                 */
                get qos(): boolean
                 ...
                 * @param params
                 */
                vfunc_filter_meta(query: Gst.Query, api: (GObject.GType | { $gtype: GObject.GType }), params: Gst.Structure): boolean
                /**
                 * @param direction
                 * @param caps
                 * @param othercaps
            ...
            interface CollectPads extends Gst.Object {
                ...
                readonly $writableProperties: CollectPads.WritableProperties
                readonly $constructOnlyProperties: CollectPads.ConstructOnlyProperties
                /**
            ...
            interface DataQueue extends GObject.Object {
                ...
                readonly $writableProperties: DataQueue.WritableProperties
                readonly $constructOnlyProperties: DataQueue.ConstructOnlyProperties
                /**
                 * @default 0
                 */
                get currentLevelBytes(): number
            ...
            interface PushSrc extends BaseSrc {
                ...
                readonly $writableProperties: PushSrc.WritableProperties
                readonly $constructOnlyProperties: PushSrc.ConstructOnlyProperties
                /**
            ...
            interface BitReader {
                 ...
                 * @returns %TRUE if successful, %FALSE otherwise., Pointer to a #guint16 to store the result
                 */
                get_bits_uint16(nbits: number): [boolean, number]
                /**
                 * Read `nbits` bits into `val` and update the current position.
                 * @param nbits number of bits to read
                 * @returns %TRUE if successful, %FALSE otherwise., Pointer to a #guint32 to store the result
                 */
                get_bits_uint32(nbits: number): [boolean, number]
                /**
                 * Read `nbits` bits into `val` and update the current position.
                 * @param nbits number of bits to read
                 * @returns %TRUE if successful, %FALSE otherwise., Pointer to a #guint64 to store the result
                 */
                get_bits_uint64(nbits: number): [boolean, number]
                /**
                 * Read `nbits` bits into `val` and update the current position.
                 * @param nbits number of bits to read
                 * @returns %TRUE if successful, %FALSE otherwise., Pointer to a #guint8 to store the result
                 */
            ...
            interface ByteReader {
                 ...
                 * @returns %TRUE if successful, %FALSE otherwise., address of a     #guint8 pointer variable in which to store the result
                 */
                 ...
                 * @returns %TRUE if a string could be read, %FALSE otherwise. The     string put into `str` must be freed with g_free() when no longer needed., address of a     #guint16 pointer variable in which to store the result
                 */
                 ...
                 * @returns %TRUE if a string could be read, %FALSE otherwise. The     string put into `str` must be freed with g_free() when no longer needed., address of a     #guint32 pointer variable in which to store the result
                 */
                 ...
                 *
                 * This function will fail if no NUL-terminator was found in in the data.
                 * @returns %TRUE if a string could be read into `str`, %FALSE otherwise. The     string put into `str` must be freed with g_free() when no longer needed., address of a     #gchar pointer variable in which to store the result
                 */
                 ...
                 * @returns %TRUE if successful, %FALSE otherwise., Pointer to a #gfloat to store the result
                 */
                 ...
                 * and update the current position.
                 * @returns %TRUE if successful, %FALSE otherwise., Pointer to a #gdouble to store the result
                 */
                 ...
                 * and update the current position.
                 * @returns %TRUE if successful, %FALSE otherwise., Pointer to a #gint16 to store the result
                 */
                 ...
                 * and update the current position.
                 * @returns %TRUE if successful, %FALSE otherwise., Pointer to a #gint32 to store the result
                 */
                 ...
                 * and update the current position.
                 * @returns %TRUE if successful, %FALSE otherwise., Pointer to a #gint64 to store the result
                 */
                 ...
                 * @returns %TRUE if successful, %FALSE otherwise., Pointer to a #gint8 to store the result
                 */
                 ...
                 *
                 * This function will fail if no NUL-terminator was found in in the data.
                 * @returns %TRUE if a string could be found, %FALSE otherwise., address of a     #gchar pointer variable in which to store the result
                 */
                 ...
                 *
                 * This function will fail if no NUL-terminator was found in in the data.
                 * @returns %TRUE if a string could be skipped, %FALSE otherwise., address of a     #gchar pointer variable in which to store the result
                 */
             ...
             */
            type CollectDataDestroyNotify = (data: CollectData) => void
            /**
             ...
             */
            type CollectPadsBufferFunction = (pads: CollectPads, data: CollectData, buffer: Gst.Buffer) => Gst.FlowReturn
            /**
             ...
             * @returns a #GstFlowReturn that corresponds to the result of clipping., the output #GstBuffer
             */
            type CollectPadsClipFunction = (pads: CollectPads, data: CollectData, inbuffer: Gst.Buffer) => [Gst.FlowReturn, Gst.Buffer]
            /**
             ...
             */
            type CollectPadsCompareFunction = (pads: CollectPads, data1: CollectData, timestamp1: Gst.ClockTime, data2: CollectData, timestamp2: Gst.ClockTime) => number
            /**
             ...
             */
            type CollectPadsEventFunction = (pads: CollectPads, pad: CollectData, event: Gst.Event) => boolean
            /**
             ...
             * @param pads a #GstCollectPads
             */
            type CollectPadsFlushFunction = (pads: CollectPads) => void
            /**
             * A function that will be called when all pads have received data.
             * @param pads the #GstCollectPads that triggered the callback
             * @returns %GST_FLOW_OK for success
             */
            type CollectPadsFunction = (pads: CollectPads) => Gst.FlowReturn
            /**
             ...
             * @param checkdata
             */
            type DataQueueEmptyCallback = (queue: DataQueue, checkdata: never | null) => void
            /**
             * @param queue
             * @param checkdata
             */
            type DataQueueFullCallback = (queue: DataQueue, checkdata: never | null) => void
            /**
