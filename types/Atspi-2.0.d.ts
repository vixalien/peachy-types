    ...
    export namespace GI {
        ...
        namespace Atspi {
            ...
            namespace Accessible {
                interface SignalSignatures extends Object.SignalSignatures, Action.SignalSignatures, Collection.SignalSignatures, Component.SignalSignatures, Document.SignalSignatures, EditableText.SignalSignatures, Hypertext.SignalSignatures, Image.SignalSignatures, Selection.SignalSignatures, Table.SignalSignatures, TableCell.SignalSignatures, Text.SignalSignatures, Value.SignalSignatures {
                    /**
            ...
            namespace Device {
                interface SignalSignatures extends GObject.Object.SignalSignatures {
                     ...
                     * @param accessible The accessible from which the              coordinates are relative. May be a top-level accessible for              the application.
                     * @param x The x coordinate relative to `accessible`.
                     * @param y The y coordinate relative to `accessible`.
                     */
            ...
            interface Device extends GObject.Object {
                ...
                /**
                 * @param kd a #AtspiKeyDefinition specifying the key code to grab.
            ...
            interface DeviceClass extends Omit<GObject.ObjectClass, "new"> {
                 ...
                 * @since 2.55
                 * @param app_id The application ID of the application that created this device.
                 * @returns a pointer to a newly-created #AtspiDevice.
                 */
            ...
            interface DeviceA11yManager extends Device {
                ...
                readonly $writableProperties: DeviceA11yManager.WritableProperties
                readonly $constructOnlyProperties: DeviceA11yManager.ConstructOnlyProperties
            }
            ...
            interface DeviceA11yManagerClass extends Omit<DeviceClass, "new"> {
                 ...
                 * @since 2.55
                 * @returns a pointer to a newly-created #AtspiDeviceA11yManager
                 */
                try_new(): DeviceA11yManager
                /**
                 * @since 2.55
                 * @param app_id The app id Tries to create a new #AtspiDeviceA11yManager with the given app id.
                 * @returns a pointer to a newly-created #AtspiDeviceA11yManager if it could establish the required DBus connection, NULL otherwise.
                 */
            ...
            interface DeviceLegacy extends Device {
                ...
                readonly $writableProperties: DeviceLegacy.WritableProperties
                readonly $constructOnlyProperties: DeviceLegacy.ConstructOnlyProperties
            }
            ...
            interface DeviceListener extends GObject.Object {
                ...
                readonly $writableProperties: DeviceListener.WritableProperties
                readonly $constructOnlyProperties: DeviceListener.ConstructOnlyProperties
                /**
            ...
            interface DeviceX11 extends Device {
                ...
                readonly $writableProperties: DeviceX11.WritableProperties
                readonly $constructOnlyProperties: DeviceX11.ConstructOnlyProperties
            }
            ...
            interface EventListener extends GObject.Object {
                ...
                readonly $writableProperties: EventListener.WritableProperties
                readonly $constructOnlyProperties: EventListener.ConstructOnlyProperties
                /**
            ...
            interface EventListenerClass extends Omit<GObject.ObjectClass, "new"> {
                 ...
                 */
                "new"(callback: EventListenerCB): EventListener
                /**
                 ...
                 * @returns #TRUE if successful, otherwise #FALSE.
                 */
                deregister_from_callback(callback: EventListenerCB, event_type: string): boolean
                /**
                 ...
                 */
                register_from_callback(callback: EventListenerCB, event_type: string): boolean
                /**
                 * @throws {GLib.Error}
                 ...
                 * @returns #TRUE if successful, otherwise #FALSE.
                 */
                register_from_callback_full(callback: EventListenerCB, event_type: string, properties: string[]): boolean
                /**
                 * @throws {GLib.Error}
                 * @param callback an   #AtspiEventListenerCB function pointer.
                 * @param event_type
            ...
            interface MatchRule extends GObject.Object {
                ...
                readonly $writableProperties: MatchRule.WritableProperties
                readonly $constructOnlyProperties: MatchRule.ConstructOnlyProperties
            }
            ...
            interface MatchRuleClass extends Omit<GObject.ObjectClass, "new"> {
                 ...
                 * @param interfaces An array of interfaces to              match, or NULL if not applicable.  Interface names should be              specified by the final component of their DBus names              (Accessible, Component, etc). For Action, it is possible to              specify an action name by enclosing it in parenthesis after              the interface name, in which case only accessibles that              implement that particular action will be returned. For              instance, Action(click) will return accessibles that provide              an action called "click".
             ...
             */
            type DeviceListenerCB = (stroke: DeviceEvent) => boolean
            /**
             * Similar to #AtspiDeviceListenerCB, but with no user data.
             * @param stroke The #AtspiDeviceEvent for which notification is   being received.
             * @returns #TRUE if the client wishes to consume/preempt the event, preventing it from being relayed to the currently focussed application, #FALSE if the event delivery should proceed as normal.
             */
            type DeviceListenerSimpleCB = (stroke: DeviceEvent) => boolean
            /**
             ...
             */
            type EventListenerCB = (event: Event) => void
            /**
